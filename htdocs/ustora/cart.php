...
<html lang="en">
  <head>
    ...
    <![endif]-->
    <script src="//assets.adobedtm.com/0c9c1bde68ac9a953a9e3d6d7397f56b953ee720/satelliteLib-5bfdcefed90f9f425e17204fdd04085c1b851775-staging.js"></script>
  </head>
  <body>
                            ...
                            <form method="post" action="#">
                                <table cellspacing="0" class="shop_table cart">
                                    ...
                                    <tbody>
                                    	...
                                    	if(isset($this->af->cartProducts)){
                                    		foreach($this->af->cartProducts as $product){
                                    			?>
                                    			<td class="product-remove">
                                                	<a title="Remove this item" class="remove" href="#">×</a> 
                                            	</td>
                                    			<td class="product-thumbnail">
                                               		<a href=""><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo imgFolder.$this->af->product['image_url']; ?>"></a>
                                            	</td>
