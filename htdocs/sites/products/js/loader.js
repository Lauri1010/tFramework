...
(function(window,document){
    ...
    }else if(host=="www.sandbox.diimo.fi"){
        localJsPath='https://www.sandbox.diimo.fi/sites/products/js/';
    }
...
/*    var fp2 = function() {
    ...
    var sl = [
        ['https://code.jquery.com/jquery.min.js', fp1, false, 1],
        ['https://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js', fp1, false, 1],
        //[localJsPath+'owl.carousel.min.js', fp1, false, 1],
        //[localJsPath+'jquery.sticky.js', fp1, false, 1],
        //[localJsPath+'experiences.js', fp1, false, 1],
