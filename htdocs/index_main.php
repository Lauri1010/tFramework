...
<div class="container">
<div class="row">
	  <div class="col s12" style="background-color:#F0F8FF">
<ul id="slide-out" class="side-nav full">
  <li><a href="#!">First Sidebar Link</a></li>
  <li><a href="#!">Second Sidebar Link</a></li>
  </ul>
  
   <a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons" style="font-size:55px;">menu</i></a>
</ul>
