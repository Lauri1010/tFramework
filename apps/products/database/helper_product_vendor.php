...
public $product_vendor_accounts_join_sql=' product_vendor_accounts pva3 ON(pv2.vendor_id=pva3.product_vendor_id_ref)';
public $product_vendor_financials_join_sql=' product_vendor_financials pvf4 ON(pv2.vendor_id=pvf4.product_vendor_id_ref)';
