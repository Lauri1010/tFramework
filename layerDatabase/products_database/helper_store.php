...
public $table_alias='s4';

public $store_id_sql='s4.store_id';

public $store_name_sql='s4.store_name';

public $select_columns_sql='s4.store_id,s4.store_name';

public $product_join_sql=' product p0 ON(s4.store_id=p0.product_store_id_ref)';
