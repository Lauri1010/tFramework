...
require ROOT.DS.FRFOLDER.DS.'layerDatabase'.DS.'products_database'.DS.'helper_product_vendor_financials.php'; 

class model_product_vendor_financials extends helper_product_vendor_financials {
